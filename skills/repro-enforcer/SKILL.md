---
name: repro-enforcer
description: "Use when working on export any bioinformatics analysis as a reproducible bundle with Conda environment, Singularity container definition, and Nextflow pipeline."
version: 0.1.0
metadata:
  openclaw:
    requires:
