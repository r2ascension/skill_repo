...
description: "Use when working with an AI agent for therapeutic discovery that executes transparent, multi-step omics analyses including research planning, code execution, and literature reasoning."
license: MIT
metadata:
