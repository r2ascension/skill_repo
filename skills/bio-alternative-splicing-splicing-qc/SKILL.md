---
name: bio-alternative-splicing-splicing-qc
description: "Use when checking whether RNA-seq data is suitable for alternative splicing analysis, including read length/depth, strandedness, STAR 2-pass alignment, junction saturation, novel junction rate, overhangs, annotation choice, or splice-site quality diagnostics."
tool_type: python
primary_tool: RSeQC
---
