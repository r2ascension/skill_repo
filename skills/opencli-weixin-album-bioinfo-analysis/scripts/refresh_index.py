    ...
    CONFIG = {
        "url": "https://mp.weixin.qq.com/mp/appmsgalbum?action=getalbum&__biz=MzU5MDkyMjc4OA==&scene=1&album_id=3892424576428326924&count=3&from=singlemessage#wechat_redirect",
        "skill_name": "opencli-weixin-album-bioinfo-analysis",
        "focus": "bioinformatics analysis practice, especially single-cell analysis, bulk RNA-seq, GSEA, GO or KEGG enrichment, and machine-learning workflow scripts",
        "scope_note": "keep the whole album because 生信分析 is already a dedicated bioinformatics-analysis collection",
        "boundary_note": "the album includes paid items; keep them listed as catalog entries but do not assume their full body can always be downloaded anonymously.",
        "categories": [
            {"key": "single-cell", "title": "Single-Cell Analysis", "keywords": ["单细胞", "细胞群", "表达差异"], "summary": "Covers single-cell analysis, cell-group comparisons, and practical visualization or interpretation work."},
{"key": "bulk-rnaseq-and-gsea", "title": "Bulk RNA-Seq And GSEA", "keywords": ["Bulk", "RNAseq", "GSEA", "单基因"], "summary": "Focuses on bulk RNA-seq, single-gene GSEA, and related transcriptome workflows."},
{"key": "enrichment-and-ml", "title": "Enrichment And Machine Learning", "keywords": ["GO", "KEGG", "机器学习", "建模", "评估"], "summary": "Highlights enrichment analysis and machine-learning or automated-model workflow."}
        ],
    }
