...
description: "Use when working on local protein structure prediction with AlphaFold, Boltz, or Chai. Compare predicted structures, compute RMSD, visualise 3D models."
version: 0.1.0
metadata:
  openclaw:
    requires:
