    ...
    CONFIG = {
        "url": "https://mp.weixin.qq.com/mp/appmsgalbum?action=getalbum&__biz=Mzg2NDcxMzYwNg==&scene=1&album_id=2997886447296839691&count=3&from=singlemessage#wechat_redirect",
        "skill_name": "opencli-weixin-album-monthly-single-cell",
        ...
        "scope_note": "keep the full album because 月更—单细胞 is already a focused single-cell tutorial collection",
        "boundary_note": "",
        "categories": [
            {"key": "qc-and-preprocessing", "title": "QC And Preprocessing", "keywords": ["QC", "nCount_RNA", "nFeature_RNA", "SoupX", "DecontX", "污染"], "summary": "Focuses on single-cell QC, contamination removal, and preprocessing logic."},
{"key": "microenvironment-and-communication", "title": "Microenvironment And Communication", "keywords": ["NicheNet", "微环境"], "summary": "Covers microenvironment inference, cell-cell communication, or related niche analysis."},
{"key": "workflow-and-parameters", "title": "Workflow And Parameter Tuning", "keywords": ["resolution", "教程", "单细胞", "空间转录组"], "summary": "Highlights workflow choices and parameter-setting guidance for single-cell or spatial data analysis."}
        ],
    }
