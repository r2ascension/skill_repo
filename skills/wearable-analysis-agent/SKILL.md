...
description: "Use when analyzing longitudinal wearable sensor data (heart rate, activity, sleep) to detect anomalies and provide personalized health insights."
keywords:
  - wearable
  - sensor-data
  - health-monitoring
