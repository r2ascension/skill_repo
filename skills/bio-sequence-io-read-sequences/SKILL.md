---
name: bio-sequence-io-read-sequences
description: "Use when reading, loading, parsing, iterating, indexing, or extracting biological sequence records from FASTA, FASTQ, GenBank, EMBL, ABI, SFF, or large multi-sequence files with Biopython SeqIO."
tool_type: python
