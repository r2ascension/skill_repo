...
description: "Use when matching patients to clinical trials, ranking trial eligibility, extracting inclusion/exclusion criteria, or producing clinical trial shortlists."
keywords:
  - retrieval
  - ranking
  - ClinicalTrials
