...
description: "Use when mapping short reads with Bowtie2 or flexible local/end-to-end alignment, especially ChIP-seq, ATAC-seq, DNA sequencing, adapter-trimmed reads, or cases needing gapped short-read alignment."
tool_type: cli
