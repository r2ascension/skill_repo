...
description: "Use when finding Gene Ontology (GO) functions, biological themes, molecular functions, cellular components, or over-represented terms in a gene list from differential expression or other omics results."
tool_type: r
