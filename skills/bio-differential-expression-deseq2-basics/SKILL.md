...
description: "Use when identifying differentially expressed genes (DEGs) from RNA-seq count data with DESeq2 in R/Bioconductor, including DESeqDataSet setup, contrasts, normalization, Wald tests, LFC shrinkage, and MA/volcano-ready results."
tool_type: r
primary_tool: DESeq2
---
