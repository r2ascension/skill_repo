...
description: "Comprehensive citation management for academic research. Use when the job is finding exact papers, verifying citation metadata, converting DOI or PMID identifiers, generating BibTeX, or cleaning a reference list. For broader literature synthesis or review writing, prefer the literature routers."
...
Use this skill for citation metadata, BibTeX, DOI or PMID conversion, and reference validation.

Prefer other skills for:

- broad paper discovery or screening: `literature-workflows-router`
- full review or survey writing: `literature-review`
- strict Nature, Cell, or Science-family citation policies: `nature-citation`
...
**Literature Review Skill** 鈫?Systematic search and synthesis
**Citation Management Skill** 鈫?Technical citation handling
