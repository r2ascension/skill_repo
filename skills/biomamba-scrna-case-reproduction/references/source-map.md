...
- In `/home/h2048`, treat these case reproductions as dated analysis runs with outputs under `data/R/<YYYYMMDD>/...` or `data/py/<YYYYMMDD>/...`, logs under `logs/<YYYYMMDD>/...`, and experiment notes under `docs/experiments/`.
