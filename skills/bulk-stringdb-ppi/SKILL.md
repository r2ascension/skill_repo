...
description: "Use when building protein-protein interaction (PPI) networks for gene lists, querying STRING, finding interaction partners or modules, or rendering PPI graphs from bulk omics results with OmicVerse or pyPPI."
---
