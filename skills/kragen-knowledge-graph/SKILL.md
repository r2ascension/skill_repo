...
description: "Use when building or querying biomedical knowledge graphs, Graph-RAG systems, entity relationships, evidence networks, or graph-based biomedical reasoning."
keywords:
  - knowledge-graph
  - RAG
  - reasoning
