...
description: "Use when exploring single-cell RNA-seq data interactively, inspecting clusters, markers, QC, embeddings, or computational biology analysis results."
keywords:
  - single-cell
  - visualization
  - web-app
