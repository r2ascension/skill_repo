---
name: nature-writing
description: "Draft, restructure, or plan Nature or CNS style manuscript sections from claims, results, figures, notes, or Chinese drafts. Use when the user explicitly wants Nature, Cell, Science, or high-impact-journal framing, or wants Chinese-to-English high-impact manuscript rewriting. For general academic writing without that venue or style signal, prefer broader academic-writing routers and the more domain-specific manuscript skills."
version: 1.0.0
...
This skill is for explicit Nature or CNS style work, high-impact-journal positioning, or Chinese-to-English rewriting in that style.

Use other routers first for:

- general academic manuscript drafting without a Nature-style requirement: `academic-writing-router`
- statistics-heavy manuscripts: `stats-paper-writing-agent-skills/skills/stat-writing`
- ML or AI venue papers: `AI-Research-SKILLs/20-ml-paper-writing/ml-paper-writing`
