...
description: "Use when searching Open Targets drug-disease associations with natural language queries. Target validation powered by Valyu semantic search."
keywords:
  - open-targets
  - drug-targets
  - target-validation
