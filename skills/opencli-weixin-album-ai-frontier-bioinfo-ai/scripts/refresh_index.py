    ...
    CONFIG = {
        "url": "https://mp.weixin.qq.com/mp/appmsgalbum?action=getalbum&__biz=MzI5MDg4NDI1OA==&scene=1&album_id=3573867404540919809&count=3&from=singlemessage#wechat_redirect",
        "skill_name": "opencli-weixin-album-ai-frontier-bioinfo-ai",
        ...
        "scope_note": "keep the whole album because AI最前沿 is already a dedicated AI-progress collection from 生物信息与人工智能",
        "boundary_note": "",
        "categories": [
            {"key": "agents-and-rag", "title": "Agents, RAG, And Workflow Systems", "keywords": ["RAG", "Agent", "智能体", "MCP", "workflow"], "summary": "Covers agent systems, RAG pipelines, MCP, and workflow orchestration for practical AI use."},
{"key": "ai-for-biology", "title": "AI For Biology And Research", "keywords": ["Bio", "生物", "Biomni", "实验", "科研"], "summary": "Highlights AI systems applied to biology, biomedical research, or autonomous experimentation."},
{"key": "ai-trends", "title": "AI Trends And Frontier Discussion", "keywords": ["提示词", "模型", "前沿", "大模型"], "summary": "Tracks broader AI-trend analysis, prompting discussion, and frontier model updates."}
        ],
    }
