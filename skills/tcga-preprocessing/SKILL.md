...
description: "Use when preparing TCGA bulk omics data for analysis, including sample sheets, expression archives, clinical carts, survival metadata, cohort annotation, and AnnData export through OmicVerse."
---
