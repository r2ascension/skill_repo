...
description: "Use when using the local Biomni checkout to orchestrate its 150+ biomedical tools, databases, and know-how workflows for complex research questions."
allowed-tools:
  - read_file
  - run_shell_command
---
