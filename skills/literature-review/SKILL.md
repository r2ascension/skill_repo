...
description: "Conduct comprehensive, systematic literature reviews using multiple academic databases. Use when the user needs a review, survey, scoping review, meta-analysis support, or research-synthesis deliverable rather than only an initial paper search or citation cleanup."
...
Use this skill when the deliverable is a literature review or synthesis document.

Prefer other skills for:

- initial paper discovery or citation chasing: `literature-workflows-router`
- metadata cleanup or BibTeX generation: `academic-citation-router`
...
**鈿狅笍 MANDATORY: Every literature review MUST include at least 1-2 AI-generated figures using the scientific-schematics skill.**
...
5. **Create PRISMA Flow Diagram**:
   ```
   Initial search: n = X
   鈹溾攢 After deduplication: n = Y
   鈹溾攢 After title screening: n = Z
   鈹溾攢 After abstract screening: n = A
   鈹斺攢 Included in review: n = B
   ```
...
2. **Screen systematically**: Title 鈫?Abstract 鈫?Full text
