...
description: "Use when analyzing cell-cell communication from annotated single-cell data, including ligand-receptor networks, CellPhoneDB v5, CellChat-style visualizations, source/target signaling, paracrine signaling, or pathway-level interactions."
---
