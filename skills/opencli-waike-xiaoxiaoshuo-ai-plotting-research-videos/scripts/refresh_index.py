    ...
    CONFIG = {
        "skill_name": "opencli-waike-xiaoxiaoshuo-ai-plotting-research-videos",
        "channel_name": "外科小小硕",
        "uid": "277408458",
        "channel_url": "https://space.bilibili.com/277408458",
        "scope_note": "keep videos about plotting, AI tools for analysis or writing, Codex or ClaudeR workflow, prediction-model methodology, or broader research-method execution",
        "boundary_note": "exclude casual commentary unless it contains concrete reusable workflow guidance for AI, plotting, or research methods.",
        "include_keywords": ["Codex", "Claude", "AI Agent", "DeepSeek", "预测模型", "绘图", "图表", "投稿", "写作", "Rstudio", "科研绘图", "临床数据自动统计分析", "期刊格式", "Gemini"],
        "exclude_keywords": [],
        "manual_include_bvids": [],
        "manual_exclude_bvids": [],
        "include_all": False,
        "categories": [
            {"key": "ai-workflow", "title": "AI Workflow And Coding Agents", "keywords": ["Codex", "Claude", "AI Agent", "DeepSeek", "Rstudio", "Gemini"], "summary": "Explains how AI tools, coding agents, or model-assisted workflow can support medical research execution."},
{"key": "plotting-and-visualization", "title": "Plotting And Visualization", "keywords": ["绘图", "图表", "Adobe illustrator", "AI科研绘图"], "summary": "Focuses on figure making, layout, beautification, or other research-visualization workflow."},
{"key": "research-methods", "title": "Research Methods And Writing", "keywords": ["预测模型", "写作", "投稿", "格式", "指南", "TRIPOD", "期刊"], "summary": "Covers research-method execution, reporting guidance, journal-formatting, or model-building workflow."}
        ],
    }
    ...
    def write_outputs(selected: list[dict], output_dir: Path) -> None:
        ...
        stem = "waike-xiaoxiaoshuo-ai-plotting-research-videos"
        ...
        text = [
            f"# OpenCLI 外科小小硕 AI Plotting Research Videos Map",
            "",
            f"- Snapshot date: `{snapshot_date}`",
            "- Source: live collection through `opencli bilibili user-videos`",
            f"- Channel: [{CONFIG['channel_name']}](https://space.bilibili.com/277408458)",
