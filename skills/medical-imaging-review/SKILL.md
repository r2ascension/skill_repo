...
description: "Use when writing medical imaging AI literature reviews, survey papers, systematic reviews, or academic overviews on segmentation, detection, classification, CT, MRI, X-ray, ultrasound, pathology, or deep learning imaging methods."
metadata:
  author: user
  version: "2.0.0"
allowed-tools:
