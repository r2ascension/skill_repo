    ...
    CONFIG = {
        "skill_name": "opencli-sanzhuang-bioinfo-videos",
        "channel_name": "散装生信散哥",
        "uid": "280749894",
        "channel_url": "https://space.bilibili.com/280749894",
        "scope_note": "keep videos that directly teach bioinformatics analysis, especially single-cell, GEO or TCGA, enrichment, immune infiltration, survival modeling, or supporting R visualization code",
        "boundary_note": "include plotting or table-format tutorials only when they are clearly attached to a bioinformatics analysis workflow.",
        "include_keywords": ["单细胞", "scRNA", "Seurat", "GSVA", "GSEA", "GEO", "TCGA", "RNA-Seq", "生信", "免疫浸润", "CIBERSORT", "TIMER", "cox", "生存分析", "limma", "GO", "KEGG", "GTEX"],
        "exclude_keywords": [],
        "manual_include_bvids": [],
        "manual_exclude_bvids": [],
        "include_all": False,
        "categories": [
            {"key": "single-cell", "title": "Single-Cell Workflow", "keywords": ["单细胞", "scRNA", "Seurat", "Umap"], "summary": "Covers single-cell data loading, Seurat workflow, clustering, scoring, or differential analysis."},
{"key": "geo-tcga-rnaseq", "title": "GEO, TCGA, And RNA-Seq", "keywords": ["GEO", "TCGA", "RNA-Seq", "GTEX", "limma"], "summary": "Focuses on public-dataset mining, RNA-seq processing, GEO or TCGA workflows, and related bulk-expression steps."},
{"key": "immune-enrichment-survival", "title": "Immune, Enrichment, And Survival", "keywords": ["GSVA", "GSEA", "CIBERSORT", "TIMER", "cox", "生存分析", "GO", "KEGG"], "summary": "Explains immune infiltration, enrichment analysis, or survival-model workflow."}
        ],
    }
    ...
    def write_outputs(selected: list[dict], output_dir: Path) -> None:
        ...
        text = [
            f"# OpenCLI 散装生信散哥 Bioinfo Videos Map",
            "",
            f"- Snapshot date: `{snapshot_date}`",
            "- Source: live collection through `opencli bilibili user-videos`",
            f"- Channel: [{CONFIG['channel_name']}](https://space.bilibili.com/280749894)",
