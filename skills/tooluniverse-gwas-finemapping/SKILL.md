...
description: "Use when fine-mapping GWAS loci, prioritizing causal SNPs/variants, building credible sets, linking variants to effector genes, annotating functional consequences, or planning validation for disease loci."
---
