---
name: labstep
description: "Use when working on interact with the Labstep electronic lab notebook API using labstepPy. Query experiments, protocols, resources, inventory, and other lab entities."
version: 0.1.0
metadata:
  openclaw:
    requires:
