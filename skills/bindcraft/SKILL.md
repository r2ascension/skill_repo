---
name: bindcraft
description: "Use when designing protein binders with BindCraft, running binder campaigns, comparing protocol settings, or combining backbone and sequence optimization with built-in AF2 validation."
license: MIT
