...
description: "Use when processing 16S rRNA or ITS amplicon FASTQs, denoising reads, inferring ASVs, filtering quality/chimeras, running DADA2-style workflows, or generating ASV tables for microbiome analysis."
tool_type: r
primary_tool: dada2
---
