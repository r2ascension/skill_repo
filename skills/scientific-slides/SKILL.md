...
description: "Build slide decks and presentations for research talks. Use for general scientific talks, seminar decks, conference presentations, and Beamer or PowerPoint oral presentation guidance when the user does not specifically need template-preserving thesis-defense automation or Nature-style paper-to-PPT workflows."
...
Use this skill for general oral scientific presentations and slide-structure guidance.

Prefer other skills for:

- editable defense PPTX generation with template preservation and QA: `thesis-defense-pptx`
- Nature-style or Chinese paper-to-PPT workflows: `nature-paper2ppt`
- image-first slide batches generated from papers: `research-skills/paper-slide-deck`
...
Diagram slide:
"Presentation slide showing the research methodology. Title: 'Study Design'. Flowchart showing: Patient Screening 鈫?Randomization 鈫?Treatment Groups (A, B, Control) 鈫?Follow-up 鈫?Analysis. CONSORT-style flow diagram. Professional academic style."
```
...
```
"Flowchart showing machine learning pipeline: Data Collection 鈫?Preprocessing 鈫?Model Training 鈫?Validation 鈫?Deployment. Clean technical style, blue and gray colors."
...
鉂?**What Makes Presentations Dry and Forgettable:**
...
鉁?**What Makes Presentations Engaging and Memorable:**
...
- Structure: Brief intro 鈫?minimal methods 鈫?key results 鈫?quick conclusion
...
- Structure: Problem 鈫?significance 鈫?approach 鈫?feasibility 鈫?impact
...
- Structure: Context 鈫?methods 鈫?results 鈫?critical analysis
...
- All text readable (鈮?8pt equivalent)
- Adequate contrast (鈮?.5:1)
...
- [ ] One main idea per slide
- [ ] Font sizes 鈮?8pt (preferably 24pt+)
...
- 4-6 words per bullet (shorter than 6脳6 rule)
- Key terms in bold
...
1. **Research & Plan** (45 minutes):
   ...
   - Outline content (intro 鈫?methods 鈫?2-3 key results 鈫?conclusion)
