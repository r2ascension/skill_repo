---
name: boltz
description: "Use when predicting protein, protein-protein, or protein-ligand structures with Boltz, validating designed binders, or using an open-source alternative to AlphaFold-style prediction on local GPUs."
license: MIT
