    ...
    CONFIG = {
        "url": "https://mp.weixin.qq.com/mp/appmsgalbum?action=getalbum&__biz=MzI1Njk4ODE0MQ==&scene=1&album_id=3928679440007446532&count=3&from=singlemessage&devicetype=android-35&version=28003653&lang=en&nettype=WIFI&ascene=1&pass_ticket=KabJsKRRAKTGANen3VLe468jy1igbpd%2FrLqJXEvvAjbG4WTGtEEcJ9axZQ4RKoYh&wx_header=3",
        "skill_name": "opencli-weixin-album-biomuse-tumor-immunity-notes",
        ...
        "scope_note": "keep the whole album because biomuse的肿瘤免疫笔记 is already a tightly scoped tumor-immunity note collection",
        "boundary_note": "",
        "categories": [
            {"key": "tumor-immunology-papers", "title": "Tumor Immunology Paper Notes", "keywords": ["Cancer Cell", "Nature", "免疫", "肿瘤"], "summary": "Focuses on tumor immunology and high-impact paper-note articles."},
{"key": "single-cell-and-multiomics", "title": "Single-Cell And Multi-Omics", "keywords": ["单细胞", "多组学", "ATAC", "DNA", "克隆"], "summary": "Highlights single-cell and multi-omics method interpretation, lineage tracing, and data-integration reading."},
{"key": "literature-and-biomarkers", "title": "Literature, Biomarkers, And Translational Notes", "keywords": ["标志物", "预警", "解析"], "summary": "Covers translational findings, biomarker notes, and interpretation-focused literature summaries."}
        ],
    }
