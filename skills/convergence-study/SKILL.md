...
description: "Use when working on spatial and temporal convergence analysis with Richardson extrapolation and Grid Convergence Index (GCI) for solution verification."
allowed-tools:
  - Bash
  - Read
---
