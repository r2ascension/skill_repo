...
description: "Use when conducting broad biomedical research with Biomni-style agents, combining literature, databases, code execution, and multi-step biological reasoning."
license: MIT
metadata:
