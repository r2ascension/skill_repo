...
description: "Use when building or using chat assistants over EHR/clinical records, summarizing patient charts, answering clinician questions, or retrieving structured information from health records."
keywords:
  - EHR
  - clinical
  - summarization
