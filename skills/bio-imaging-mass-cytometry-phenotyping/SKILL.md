...
description: "Use when assigning cell types to segmented IMC cells based on protein marker expression or when phenotyping cells in multiplexed imaging data."
tool_type: python
primary_tool: scanpy
---
