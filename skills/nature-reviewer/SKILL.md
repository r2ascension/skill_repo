...
description: "Simulate a Nature-style reviewer assessment from the referee perspective. Use when the user explicitly wants a Nature-style mock review, high-impact-journal referee framing, or a reviewer package modeled after Nature-family assessment. For general peer review, prefer peer-review."
version: 0.1.0
status: Draft
---
...
Use this skill for a Nature-style mock reviewer package.

Prefer other skills for:

- general manuscript or grant review: `peer-review`
- author-side response letters: `nature-response`
