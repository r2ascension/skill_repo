...
description: "Use when mapping GWAS loci to candidate effector genes, integrating L2G, MAGMA/FUMA, PoPS, cS2G, TWAS, colocalization, enhancer-gene links, or tissue-specific evidence to nominate causal genes."
tool_type: mixed
primary_tool: MAGMA
---
...
| Deep-learning variant effect (optional 7th) | chromBPNet / EnFormer in silico variant effect on accessibility/expression at credible variant | \|log2FC\| > 1 (chromBPNet strong-effect); agreement across two models | Avsec 2021; cross-reference atac-seq/deep-learning-atac |
