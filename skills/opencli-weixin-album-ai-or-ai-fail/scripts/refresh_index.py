    ...
    CONFIG = {
        ...
        "scope_note": "keep the whole album because it is already curated as a practical AI-for-research series by 生信菜鸟团",
        "boundary_note": "",
        "categories": [
            {"key": "ai-coding-practice", "title": "AI Coding Practice", "keywords": ["代码", "编程", "文件夹", "脚本", "需求"], "summary": "Focuses on hands-on AI coding practice, code-generation issues, and practical implementation workflow."},
{"key": "data-and-scale", "title": "Data Handling And Scale", "keywords": ["单细胞", "数据", "千万级", "处理"], "summary": "Covers AI or workflow discussions tied to large data handling, scaling, or bioinformatics datasets."},
{"key": "prompt-and-usage", "title": "Prompting And AI Usage Pitfalls", "keywords": ["人工智能", "提示", "错", "智障"], "summary": "Highlights prompting, failure modes, and usage patterns for making AI outputs more reliable."}
        ],
    }
