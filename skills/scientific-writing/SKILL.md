...
description: "Core scientific-manuscript writing skill for IMRAD-style prose backed by research lookup. Use when the user wants full-paragraph scientific manuscript drafting or revision with citation discipline and reporting-guideline awareness, especially for general biomedical or scientific journal writing. For Nature or CNS style, statistics-specific, or ML or AI venue papers, prefer the more specialized writing skills."
...
Use this skill for general scientific IMRAD manuscripts that should remain in full paragraphs and may need reporting-guideline-aware structure.

Prefer other skills for:

- Nature or CNS style framing: `nature-writing`
- statistics-heavy manuscripts or reviewer letters: `stats-paper-writing-agent-skills/skills/stat-writing`
- ML or AI conference manuscripts: `AI-Research-SKILLs/20-ml-paper-writing/ml-paper-writing`

## Overview

**This is the core skill for the deep research and writing tool**鈥攃ombining AI-driven deep research with well-formatted written outputs. Every document produced is backed by comprehensive literature search and verified citations through the research-lookup skill.
...
**鈿狅笍 MANDATORY: Every scientific paper MUST include at least 1-2 AI-generated figures using the scientific-schematics skill.**
...
3. These bullet points serve as scaffolding鈥攖hey are NOT the final manuscript
...
- 鉂?**Never** leave bullet points in the final manuscript
- 鉂?**Never** submit lists where paragraphs should be
- 鉂?**Don't** use numbered or bulleted lists in Results or Discussion sections (except for specific cases like study hypotheses or inclusion criteria)
- 鉂?**Don't** write sentence fragments or incomplete thoughts
- 鉁?**Do** use occasional lists only in Methods (e.g., inclusion/exclusion criteria, materials lists)
- 鉁?**Do** ensure every section flows as connected prose
- 鉁?**Do** read paragraphs aloud to check for natural flow
...
- Report concentrations with appropriate units (mM, 渭M, nM, or % w/v, v/v)
...
- Use mathematical notation consistent with field standards (e.g., 鈩?for reduced Planck constant)
...
**Remember**: Bullet points are for planning only鈥攖he final manuscript must be in complete paragraphs.
