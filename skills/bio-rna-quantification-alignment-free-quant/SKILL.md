...
description: "Use when estimating transcript abundance from RNA-seq reads without full alignment, quantifying transcripts with Salmon/kallisto, pseudo-aligning reads, creating transcript counts/TPM, or preparing quantifications for tximport."
tool_type: cli
primary_tool: salmon
---
