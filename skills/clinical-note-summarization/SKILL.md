...
description: "Use when working on structure raw clinical notes into SOAP-format summaries with explicit contradictions, missing data, and ICD-linked assessments using the provided prompt + usage script."
allowed-tools:
  - read_file
  - run_shell_command
---
