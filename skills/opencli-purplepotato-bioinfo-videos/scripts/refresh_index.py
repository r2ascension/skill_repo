    ...
    CONFIG = {
        "skill_name": "opencli-purplepotato-bioinfo-videos",
        "channel_name": "小紫薯PurplePotato",
        "uid": "361123190",
        "channel_url": "https://space.bilibili.com/361123190",
        "scope_note": "keep videos that directly cover bioinformatics workflow or that clearly support bioinformatics onboarding through AI coding, R, RStudio, Linux, RNA-seq, or single-cell practice",
        "boundary_note": "exclude general medical-research statistics or PhD-application videos unless they directly support the scoped bioinformatics workflow.",
        "include_keywords": ["Codex", "Claude", "知识库", "skill", "R和R", "R语言", "R studio", "Linux", "RNA", "RNA-Seq", "单细胞", "DeepSeek", "生信", "count", "转录组"],
        "exclude_keywords": [],
        "manual_include_bvids": [],
        "manual_exclude_bvids": [],
        "include_all": False,
        "categories": [
            {"key": "ai-workflow", "title": "AI Workflow For Bioinformatics Beginners", "keywords": ["Codex", "Claude", "知识库", "skill", "DeepSeek"], "summary": "Explains how to use AI coding or knowledge-workflow tools to support bioinformatics or medical-research beginners."},
{"key": "r-linux-foundations", "title": "R And Linux Foundations", "keywords": ["R语言", "R studio", "R和R", "Linux"], "summary": "Covers the setup or basic workflow foundations that a bioinformatics beginner needs before analysis work."},
{"key": "rna-and-single-cell", "title": "RNA-Seq And Single-Cell Practice", "keywords": ["RNA", "RNA-Seq", "count", "单细胞", "转录组", "生信"], "summary": "Directly teaches RNA-seq, transcriptomics, or single-cell analysis workflow."}
        ],
    }
    ...
    def write_outputs(selected: list[dict], output_dir: Path) -> None:
        ...
        stem = "purplepotato-bioinfo-videos"
        ...
        text = [
            f"# OpenCLI PurplePotato Bioinfo Videos Map",
            "",
            f"- Snapshot date: `{snapshot_date}`",
            "- Source: live collection through `opencli bilibili user-videos`",
            f"- Channel: [{CONFIG['channel_name']}](https://space.bilibili.com/361123190)",
