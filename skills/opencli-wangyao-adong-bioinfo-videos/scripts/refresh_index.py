    ...
    CONFIG = {
        "skill_name": "opencli-wangyao-adong-bioinfo-videos",
        "channel_name": "网药阿东",
        "uid": "3546805061028473",
        "channel_url": "https://space.bilibili.com/3546805061028473",
        "scope_note": "keep the full current channel because the uploaded series is already a tightly scoped network-pharmacology and bioinformatics tutorial line",
        "boundary_note": "",
        "include_keywords": [],
        "exclude_keywords": [],
        ...
        "include_all": True,
        "categories": [
            {"key": "activity-and-databases", "title": "Active Components And Databases", "keywords": ["TCMSP", "Herb", "活性成分", "数据库", "DAVID"], "summary": "Focuses on how to retrieve active components, map disease or target resources, or use the relevant network-pharmacology databases."},
{"key": "ppi-and-cytoscape", "title": "PPI And Cytoscape", "keywords": ["cytoscape", "string", "PPI", "靶点", "网络"], "summary": "Covers target-network construction, Cytoscape setup, STRING or PPI workflow, and related graph-building steps."},
{"key": "enrichment", "title": "Enrichment And Visualization", "keywords": ["GO", "KEGG", "metascape", "富集", "气泡图"], "summary": "Explains GO or KEGG enrichment analysis, enrichment visualization, or related pathway-interpretation workflow."},
{"key": "docking", "title": "Molecular Docking", "keywords": ["Autodock", "autodock", "分子对接", "pymol", "vina"], "summary": "Covers docking environment setup, docking execution, and PyMOL or related structural visualization."}
        ],
    }
    ...
    def write_outputs(selected: list[dict], output_dir: Path) -> None:
        ...
        stem = "wangyao-adong-bioinfo-videos"
        ...
        text = [
            f"# OpenCLI 网药阿东 Bioinfo Videos Map",
            "",
            f"- Snapshot date: `{snapshot_date}`",
            "- Source: live collection through `opencli bilibili user-videos`",
            f"- Channel: [{CONFIG['channel_name']}](https://space.bilibili.com/3546805061028473)",
