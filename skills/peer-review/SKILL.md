---
name: peer-review
description: "Systematic peer review toolkit for cross-disciplinary manuscript and grant review. Use when the user wants a general reviewer-style critique, methodology audit, rigor check, or grant review without a Nature-family framing requirement."
...
Use this skill for general peer review and rigor critique.

Prefer other skills for:

- Nature-style referee simulation: `nature-reviewer`
...
**鈿狅笍 CRITICAL: For presentations, NEVER read the PDF directly. ALWAYS convert to images first.**
...
**Structure and Flow:**
- [ ] Clear narrative arc (introduction 鈫?methods 鈫?results 鈫?discussion)
