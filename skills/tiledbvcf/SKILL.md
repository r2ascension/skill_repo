---
name: tiledbvcf
description: "Use when you need efficient storage and retrieval of genomic variant data using TileDB. Scalable VCF/BCF ingestion, incremental sample addition, compressed storage, parallel queries, and export capabilities for population genomics."
license: MIT license
metadata:
