...
description: "Use when identifying DEGs from RNA-seq count data with edgeR in R/Bioconductor, including DGEList setup, TMM normalization, dispersion estimation, quasi-likelihood tests, case-control contrasts, or gene-level abundance testing."
tool_type: r
primary_tool: edgeR
---
