    ...
    CONFIG = {
        "skill_name": "opencli-ai-ghost-lab-ai-skills",
        "channel_name": "AI-Ghost-Lab",
        "uid": "1731330412",
        "channel_url": "https://space.bilibili.com/1731330412",
        "scope_note": "keep videos that teach AI workflow, prompt strategy, skills, Codex or ChatGPT usage, subagent collaboration, architecture iteration, evaluation, or leverage through AI coding",
        "boundary_note": "exclude the older security, Hack The Box, CVE, or personal-life videos unless the user explicitly asks for the whole channel history.",
        "include_keywords": ["AI", "prompt", "Skills", "AGENTS", "ChatGPT", "Codex", "subagent", "workflow", "架构", "项目", "验收", "UI", "bugfix"],
        "exclude_keywords": ["Hack The Box", "CVE", "渗透", "Kali Linux", "会员", "副业", "生活感悟"],
        "manual_include_bvids": [],
        "manual_exclude_bvids": [],
        "include_all": False,
        "categories": [
            {"key": "skills-and-collaboration", "title": "Skills, Prompts, And Collaboration", "keywords": ["Skills", "AGENTS", "prompt", "ChatGPT", "Codex", "subagent"], "summary": "Focuses on skills, prompt design, collaboration modes, AGENTS conventions, or subagent usage patterns."},
{"key": "ai-coding-workflow", "title": "AI Coding Workflow", "keywords": ["workflow", "验收", "bugfix", "测试", "流水线", "自动执行"], "summary": "Explains AI coding pipelines, validation, testing, delivery flow, or operational execution design."},
{"key": "architecture-and-project-evolution", "title": "Architecture And Project Evolution", "keywords": ["架构", "项目", "迭代", "放大", "工程"], "summary": "Reflects on architecture, project evolution, or how to scale engineering leverage with AI assistance."}
        ],
    }
    ...
    def write_outputs(selected: list[dict], output_dir: Path) -> None:
        ...
        text = [
            f"# OpenCLI AI-Ghost-Lab AI Skills Map",
            "",
            f"- Snapshot date: `{snapshot_date}`",
            "- Source: live collection through `opencli bilibili user-videos`",
            f"- Channel: [{CONFIG['channel_name']}](https://space.bilibili.com/1731330412)",
