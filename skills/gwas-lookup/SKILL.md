---
name: gwas-lookup
description: "Use when working on federated variant lookup across 9 genomic databases — GWAS Catalog, Open Targets, PheWeb (UKB, FinnGen, BBJ), GTEx, eQTL Catalogue, and more."
version: 0.1.0
metadata:
  openclaw:
    requires:
