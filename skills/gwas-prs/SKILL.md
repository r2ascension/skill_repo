---
name: gwas-prs
description: "Use when calculating or interpreting polygenic risk scores from DTC genetic data, PGS Catalog scores, genetic predisposition, or complex disease risk."
version: 0.1.0
metadata:
  openclaw:
    requires:
